...
class Grupo {
    ...
    public function Eliminagrup($idagp,$alumno){
        ...
        $delete1 = mysql_query($delete) or die ('<div align="center">El Registro Nose Puede Eliminar<br><br>
        <button align="center" type="button" class="btn btn-lg btn-default">
<a href="testAlumno.php"><b>Regresar</b></a></button></div>');
    ...
    public function AsignarAlumnoaGrupo(){
        $sql01="SELECT * FROM usuario WHERE nivel=2 AND Estatus = 1  ORDER BY Nivel";
